...
trainer = trainer(device=device,style_dim=opts.style_dim,optim_para=optim_para,gen_loss_weight_para=gen_loss_weight_para,dis_loss_weight_para=dis_loss_weight_para,train_is=True)
trainer.to(device)
